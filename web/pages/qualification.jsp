                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <a class="btn btn-info" href="${pagContext.request.contextPath}/hydadmin/pages/to-add-qualification">Add Qualification</a>
                            </div>
                            <div class="body">
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                    ...
                                    <tbody>
                                        <s:iterator value="qualificationlist" var="ql">
                                            <tr>
                                                <td><s:property value="#ql.qualificationname"/></td>
                                            </tr>
                                        </s:iterator>
                                    </tbody>
                                </table>

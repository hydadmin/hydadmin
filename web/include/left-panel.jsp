...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src="${pageContext.request.contextPath}/images/gulam.png" width="48" height="48" alt="User" />
        </div>
        <div class="info-container">
            <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${sessionScope.managerfn} ${sessionScope.managerln} ${sessionScope.adminfn} ${sessionScope.adminln} ${sessionScope.recruiterfn} ${sessionScope.recruiterln}</div>
            <div class="email">${sessionScope.emailid}</div>
            <div class="btn-group user-helper-dropdown">
                <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                <ul class="dropdown-menu pull-right">
                    <li role="seperator" class="divider"></li>
                    <li><a href="${pagContext.request.contextPath}/hydadmin/logout"><i class="material-icons">input</i>Sign Out</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <s:if test="#session.recruiterid!=null">
                        <li>
                            <a href="${pagContext.request.contextPath}/hydadmin/pages/all-designations">
                                <i class="material-icons">donut_large</i>
                    ...
                    <s:if test="#session.managerid!=null">
                        <li>
                   ...
                   <s:if test="#session.adminid!=null||#session.managerid!=null">     
                    <li>
    ...
    <!--            <div class="legal">
                    <div class="copyright">
                        &copy; 2016 <a href="javascript:void(0);">Hyderabad Manpower</a>.
                    </div>
                    <div class="version">
                        <b>Version: </b> 1.0.4
                    </div>
